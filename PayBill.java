      ...
      PayBill(String meter){
        ...
        JLabel lblunits = new JLabel("Units");
          ...
          try {
             ...
             rs = c.s.executeQuery("select * from bill where meter_no ='"+meter+"' AND '"+cmonth.getSelectedItem()+" ' ");
             while(rs.next()){
                 labelunits.setText(rs.getString("units"));
                 labeltotalbill.setText(rs.getString("bill"));
                 labeltotalbill.setText(rs.getString("status"));
             }
          }catch (Exception e) {
              e.printStackTrace();
          }
          ...
          cmonth.addItemListener(new ItemListener(){
                ...
                public void itemStateChanged(ItemEvent ae) {
                    try {
                         ...
                         ResultSet rs = c.s.executeQuery("select * from bill where meter_no ='"+meter+"' AND '"+cmonth.getSelectedItem()+" ' ");
                         while(rs.next()){
                               labelunits.setText(rs.getString("units"));
                               labeltotalbill.setText(rs.getString("bill"));
                               labeltotalbill.setText(rs.getString("status"));
